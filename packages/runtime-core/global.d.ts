...
declare global {
  ...
  const FEDERATION_ALLOW_NEW_FUNCTION: string | undefined;
...
export declare const globalLoading: Record<
  string,
  Promise<void | RemoteEntryExports> | undefined
>;
export declare function resetFederationGlobalInfo(): void;
export declare function setGlobalFederationInstance(
  FederationInstance: ModuleFederation,
): void;
export declare function getGlobalFederationConstructor():
  | typeof ModuleFederation
  | undefined;
export declare function setGlobalFederationConstructor(
  FederationConstructor: typeof ModuleFederation | undefined,
  isDebug?: boolean,
): void;
export declare function getInfoWithoutType<T extends object>(
  target: T,
  key: keyof T,
): {
...
export declare const getTargetSnapshotInfoByModuleInfo: (
  moduleInfo: Optional<Remote, 'alias'>,
  snapshot: GlobalModuleInfo,
) => GlobalModuleInfo[string] | undefined;
export declare const getGlobalSnapshotInfoByModuleInfo: (
  moduleInfo: Optional<Remote, 'alias'>,
) => GlobalModuleInfo[string] | undefined;
export declare const setGlobalSnapshotInfoByModuleInfo: (
  remoteInfo: Remote,
  moduleDetailInfo: GlobalModuleInfo[string],
) => GlobalModuleInfo;
export declare const addGlobalSnapshot: (
  moduleInfos: GlobalModuleInfo,
) => () => void;
export declare const getRemoteEntryExports: (
  name: string,
...
export declare const registerGlobalPlugins: (
